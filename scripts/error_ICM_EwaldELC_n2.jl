...
begin
    ...
    data_file = CSV.write("data/error_ICM_EwaldELC_n2.csv", DataFrame(i = Int64[], H = Float64[], r = Float64[], Lz = Float64[], γu = Float64[], γd = Float64[], M = Int[], energy = Float64[], error_r = Float64[], error_a = Float64[]))
