...
begin
    ...
    data_file = CSV.write("data/error_EwaldELC_n2.csv", DataFrame(i = Int64[], H = Float64[], rr = Float64[], energy = Float64[], error_r = Float64[], error_a = Float64[]))
    for i in 1:10
        for H in [10.0, 5.0, 1.0, 0.5, 0.1]
            ...
            for r in 0.0:10.0
                ...
                ea = abs(e - e_exact)
                rr = ((2Ns + 1) * H - H) / Lx
                @info "i = $(i), H = $(H), r = $(r), Ns = $(Ns), rr = $(rr), e = $(e), e_exact = $(e_exact), er = $(er), ea = $(ea)"
